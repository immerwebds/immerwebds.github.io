...
export const SCALE_X = 30;
export const SCALE_Y = 40;
// DS2 consts
...
export const text4 = `When the initial COVID-19 outbreak reached a global scale, millions began losing their jobs during the recession, and the S&P lost more than a thousand from its peak.`
...
export const text7 = `Pandemic-driven volatilities in the stock market has shown a pattern of falling less and recovering it faster than before. The market's recoveries were supported by the Federal Reserve's various measures and progress on vaccines and other treatments.`
